...
class Gal:
	...
	def cree_pages_albums(self):
		albumss = []
		for i in range(len(self.albumsList)):
			pass
	...
	def album_photo(self,userChoice):
		...
		liste_photo_album = list_temp
		liste_photo_album = liste_ligne(liste_photo_album,9)
		liste_bonne2 = []
		for element in liste_photo_album:
			page = liste_ligne(element,3)
			liste_bonne2.append(page)
...
def albums():
	...
	fond = fond_album3
	logo_photos.size = (46,23)
	logo_albums.size = (46,21)
	creationAlbum = False
	ajout_a_album = False
	album_montree = False
